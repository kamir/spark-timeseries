 ...
 * The time dimension is conformed in the sense that a single DateTimeIndex 
 * applies to all the univariate series. Each univariate series within 
 * the RDD has a key to identify it.
 */
