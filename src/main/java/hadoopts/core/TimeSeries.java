...
public class TimeSeries implements ITimeSeries, Serializable {
    ...
    public static double[] calcPeriodeTrend( TimeSeries mr, int d ) {
    ...
    public static TimeSeries normalizeByPeriodeTrend( TimeSeries mr, int d ) {

        TimeSeries mr2 = new TimeSeries();
    ...
    public TimeSeries replaceZeroWithAverage() {
    ...
    public static TimeSeries getUniformDistribution(int i, double d, double d0) {
        TimeSeries mr = new TimeSeries();
    ...
    public static TimeSeries getGaussianDistribution(int i) {
        TimeSeries mr = new TimeSeries();
    ...
    public static TimeSeries getGaussianDistribution(int i, double mw, double std) {
        TimeSeries mr = new TimeSeries();
    ...
    public static TimeSeries getExpDistribution(int i, double mw) {
        TimeSeries mr = new TimeSeries();
    ...
    public static TimeSeries getParetoDistribution(int i, double mw) {
        TimeSeries mr = new TimeSeries();
    ...
    public static TimeSeries getGeometricDistribution(int i, double mw) {
        TimeSeries mr = new TimeSeries();
    ...
    public static TimeSeriesFFT getGaussianDistribution2(int i, double mw, double std) {
     ...
     */public TimeSeries(String label, String xL, String yL) {
        this(label);
        this.label_Y = yL;
        this.label_X = xL;
    };
...
//        double sigma = StdStats.stddev( dy );
    ...
    public TimeSeries calcMR_Ln_for_Y() {
        TimeSeries mr = new TimeSeries( this.label.concat("_ln" ) );
    ...
    public TimeSeries divide_by( TimeSeries mr2 ) {
    ...
    public TimeSeries add(TimeSeries messreihe, int shortestLength) {
        
        TimeSeries mr = mr = new TimeSeries();
...
//        }
    ...
    public TimeSeries cutFromStart( int n ) {
    ...
    public TimeSeries addToX( int v ) {
    ...
    private TimeSeries shiftRight( int nrOfValues , double missingValue ) {
    ...
    private TimeSeries shiftLeft( int nrOfValues, double missingValue ) {
...
//    };
     ...
     * @return
     */
    static public TimeSeries averageForAll( TimeSeries[] mrs ) {
        int anz = mrs.length;
...
//        System.out.println(regression.getSlopeStdErr());
  ...
  //                  mr.addValue(last);
     ...
     * @return
     */
    public static TimeSeries calcAveragOfRows( Vector<TimeSeries> rows ) throws Exception{
        ...
        while( a < i ) {
            ...
            TimeSeries ref = rows.elementAt(0);
            ...
            for( int z=1; z<j; z++) {
                ...
                try{
                    TimeSeries vergl = rows.elementAt(z);
    ...
    public TimeSeries[] splitInto(int bin) {
    ...
    public TimeSeries subtractAverage() {
    ...
    public void append(TimeSeries mr0) {
    ...
    public TimeSeries combineAsXWithY(TimeSeries mrY) {
        TimeSeries mr = new TimeSeries();
    ...
    public TimeSeries cutOut(int begin, int ende) {
       TimeSeries r = new TimeSeries();
       // wir kürzen hier nicht die Access-Reihe, wir setzen die Werte nur auf 0;
    ...
    public static TimeSeries createFromStringLine( String s1 ) { 
    ...
    public TimeSeries normalizeToStdevIsOne() {
        TimeSeries mrNeu = normalizeToMWZeroANDSTDevONE(this);
    ...
    public TimeSeries limitTo(int i) {
        TimeSeries mr = copy( i );
        return mr;
    }
    ...
    public TimeSeries log() {
      ...
      public TimeSeries subtractFromX(double d) {
        TimeSeries mr = new TimeSeries();
        mr.setLabel( this.getLabel() );
        mr.binning = this.binning;
        mr.decimalFormat_STAT = this.decimalFormat_STAT;
    ...
    public static TimeSeries calcAVOfRows(Vector<TimeSeries> grIWL, Vector<TimeSeries> grCN, String l) {
        TimeSeries r = new TimeSeries();
        int z = 0;
        
        for( TimeSeries mr : grIWL ) { 
            r = r.add(mr);
            z++;
        }
        
        for( TimeSeries mr : grCN ) { 
            r = r.add(mr);
            z++;
        }
    ...
    public static TimeSeries calcSumOfRows(Vector<TimeSeries> grIWL, Vector<TimeSeries> grCN, String l) {
        TimeSeries r = new TimeSeries();
        int z = 0;
    ...
    public TimeSeries divideXBy(double d) {
        TimeSeries mr = new TimeSeries();
        mr.setLabel( this.getLabel() );
        mr.binning = this.binning;
        mr.decimalFormat_STAT = this.decimalFormat_STAT;
    ...
    public void addProperty(String k, String v) {
     ...
     public static TimeSeries normalizeToMWZeroANDSTDevONE(TimeSeries mrA) {
            
            TimeSeries mrB = mrA.subtractAverage();
