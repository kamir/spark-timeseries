...
public class StockDataLoader2 {
    ...
    private static void loadAndCacheStockTradingDataForYears(int[] years) {
...
//        hash.put("The_Walt_Disney_Company","DIS");
    ...
    /**
     * Just show the chart with our default settings.
     * We do not add an additional label.
     * 
     */
